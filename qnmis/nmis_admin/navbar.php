    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link" href="index.php">Add Question <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="addoption.php">Add option</a>
        </li>
        ...
        <!-- <li class="nav-item">
          <a class="nav-link" href="contact.php">Phy</a>
        </li>
 -->      </ul>
