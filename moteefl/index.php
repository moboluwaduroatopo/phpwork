...
<style type="text/css">
  .view {
    background: url("images/dev6.jpg")no-repeat center center;
...
<header>
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark scrolling-navbar">
    <a class="navbar-brand" href="#"><strong>moTeefl</strong></a>
    ...
    <div class="row">
      <div class="col-md-12 ">
        ...
        <p align="justify">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
          ...
          mollit anim id est laborum.What have done , who i am , what i can do</p>
