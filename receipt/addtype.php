...
<form   method="post" action="typeprocess.php" enctype="multipart/form-data" class="text-center border border-light p-5">
    ...
    <p class="h4 mb-4 text-white"  >Add New Categories</p>
    <!-- Phone number -->
...
require("conn.php");
          ...
          while($r=mysqli_fetch_array($select)){
             $n++;
                   $id=$r['type_id'];
                   $_SESSION['id']=$id;
echo "<tr><td class='text-white'>". $n."</td><td class='text-white'>".$r['type_name']."</td><td><img src='".$r['image']."' width=30px height =30px></td><td><a href='viewproduct.php?tid=".$r['type_id']."'><button class='btn btn-success'>View more</button></a></td><td><a href='edittype.php?id=".$id."'><button class='btn btn-success'>Edit</button></a></td>
