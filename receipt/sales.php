...
<select name="payment_type"  id="payment_type" class="browser-default custom-select">
 ...
 <option>Cash</option>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" id='saveproduct' name='submit'>Generate</button>
      </div>
      </form>
    </div>
  </div>
