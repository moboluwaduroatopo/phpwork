<?php
   ...
   //include 'conn.php';
		 function connect(){
			...
			$result=mysqli_query($this->connect, "INSERT INTO contactus_tb(name,email,subject,message,status,dateSend,datereplied) VALUES ('$name','$email','$subject','$message','unconfirmed',now(),'')");
				if ($result) {
