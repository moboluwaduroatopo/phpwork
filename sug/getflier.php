...
<body>
  ...
  <div class='container' >
<div id='testdiv'
style="background-image: url('img/img3.jpg');  background-size: cover; background-repeat: no-repeat;width: 450px;margin: 0 auto;   padding-left: 25px; padding-top: 10px;" class='text-white'>
    ...
    <div class='col-8'>
      <div class='text-center text-uppercase'>
         <span style='color:yellow;'>i'm</span><br><span>".$r['name']."</span><br><span>".$r['nickname']."</span><br>
    ...
    <div class='col-4'>
 <img src='img/".$r['image']."' style='width: 170px;height:150px;border-radius: 50%;opacity:;' class='img-fluid'> 
    </div>
  </div>

    <div class='row  justify-content-between'>
       <div class='col-4'>
       <img src='img/img2.jpg' style='width: 100px;height:100px;border-radius: 50%;margin-bottom: ' class='img-fluid'> 
